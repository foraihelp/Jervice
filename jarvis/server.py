...
def create_app(brain: Brain, api_token: str) -> FastAPI:
...
def run_server(brain: Brain, api_token: str, host: str, port: int) -> None:
    ...
    app = create_app(brain, api_token)
